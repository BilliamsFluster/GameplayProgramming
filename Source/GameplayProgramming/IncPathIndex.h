...
#include "IncPathIndex.generated.h"

/**
 * 
 */
UCLASS(Blueprintable)
class GAMEPLAYPROGRAMMING_API UIncPathIndex : public UBTTask_BlackboardBase
{
	GENERATED_BODY()
public:

	UIncPathIndex(FObjectInitializer const& ObjectInitializer);
