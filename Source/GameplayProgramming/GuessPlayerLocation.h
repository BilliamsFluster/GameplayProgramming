...
#include "GuessPlayerLocation.generated.h"

/**
 * 
 */
UCLASS(Blueprintable)
class GAMEPLAYPROGRAMMING_API UGuessPlayerLocation : public UBTTask_BlackboardBase
{
	GENERATED_BODY()

public:

	UGuessPlayerLocation(FObjectInitializer const& ObjectInitializer);
